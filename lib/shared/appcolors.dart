...
class AppColors {
  ...
  static const Color background2 = Color(0xffeeeeee);
  static const Color cursor = Color(0xff101820);
  static const Color gray = Color(0xff7f8c8d);
  static const Color disabled = Color(0xFFD4D4D4);
  static const Color grayIcon = Color.fromARGB(255, 102, 102, 102);
  static const Color darkGrayIcon = Color(0xFF252525);
